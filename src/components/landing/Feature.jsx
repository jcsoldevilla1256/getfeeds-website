export default function Feature() {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Designed for creators, teams, and professionals like you</h2>
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">At GetFeeds, we help individuals and organizations grow by turning feedback into actionable insights.
          Whether you’re a creator, a student, or a leader — your link becomes the simplest way to collect, understand, and improve.</p>
      </div>
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Creators & Influencers</h3>
              <p className="text-gray-500 dark:text-gray-400">Collect audience feedback, ratings, and reactions from one shareable link — so you know what your followers truly love.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Professionals & Teams</h3>
              <p className="text-gray-500 dark:text-gray-400">Get performance reviews, leadership insights, or peer feedback without the friction of forms and meetings.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Students & Educators</h3>
              <p className="text-gray-500 dark:text-gray-400">Gather feedback from classmates, mentors, or learners to track growth and build a stronger portfolio.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Businesses & Startups</h3>
              <p className="text-gray-500 dark:text-gray-400">Understand how your customers or employees feel through custom feedback templates and analytics.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Enterprise & HR</h3>
              <p className="text-gray-500 dark:text-gray-400">Unlock data-driven performance insights with customizable 5-star systems and private feedback flows.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Community Builders</h3>
              <p className="text-gray-500 dark:text-gray-400">Let members share thoughts openly (even anonymously) and create more trust through feedback visibility.</p>
          </div>
      </div>
  </div>
</section>
